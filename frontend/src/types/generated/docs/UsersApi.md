...
|[**getUserActivity**](#getuseractivity) | **GET** /users/me/activity | Get user\&#39;s activity data for contribution graph|
...
# **getUserActivity**
> Array<Activity> getUserActivity()
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
|**200** | A list of user\&#39;s daily activity counts. |  -  |
|**401** | Unauthorized - Authentication required or invalid credentials |  -  |
