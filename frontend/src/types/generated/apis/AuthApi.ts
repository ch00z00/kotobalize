...
export class AuthApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async loginUser(loginRequest: LoginRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        if (loginRequest === null || loginRequest === undefined) {
            throw new RequiredError("AuthApi", "loginUser", "loginRequest");
        }
     ...
     */
    public async signupUser(registerRequest: RegisterRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'registerRequest' is not null or undefined
        if (registerRequest === null || registerRequest === undefined) {
            throw new RequiredError("AuthApi", "signupUser", "registerRequest");
        }
...
export class AuthApiResponseProcessor {
     ...
     */
     public async getCurrentUserWithHttpInfo(response: ResponseContext): Promise<HttpInfo<User >> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async loginUserWithHttpInfo(response: ResponseContext): Promise<HttpInfo<AuthResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to signupUser
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async signupUserWithHttpInfo(response: ResponseContext): Promise<HttpInfo<AuthResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        ...
        if (isCodeInRange("409", response.httpStatusCode)) {
            ...
            throw new ApiException<ApiError>(response.httpStatusCode, "User with this email already exists", body, response.headers);
        }
