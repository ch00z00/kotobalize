...
export class ThemesApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createTheme(newThemeRequest: NewThemeRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'newThemeRequest' is not null or undefined
        if (newThemeRequest === null || newThemeRequest === undefined) {
            throw new RequiredError("ThemesApi", "createTheme", "newThemeRequest");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(newThemeRequest, "NewThemeRequest", ""),
            contentType
        );
...
export class ThemesApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to createTheme
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createThemeWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Theme >> {
